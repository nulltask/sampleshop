...
$app = BASE . "/app";
$lib = BASE . "/lib";
$model = BASE . "/app/model";
$manager = BASE . "/app/manager";
set_include_path(implode(PATH_SEPARATOR, array($app, $lib, $model, $manager)) . PATH_SEPARATOR . get_include_path());


/** including application library. */
require_once 'Ethna/Ethna.php';
require_once 'Sampleshop_Error.php';
require_once 'Sampleshop_ActionClass.php';
require_once 'Sampleshop_ActionForm.php';
require_once 'Sampleshop_ViewClass.php';

require_once BASE . '/etc/sampleshop-inc.php';

/**
 *  Sampleshop application Controller definition.
 *
 *  @author	 {$author}
 *  @access	 public
 *  @package	Sampleshop
 */
class Sampleshop_Controller extends Ethna_Controller
{
	/**#@+
	 *  @access private
	 */
	...
	var $forward = array(
		 ...
		 *
		 *  'index'		 => array(
		 *	  'view_name' => 'Sampleshop_View_Index',
		 *  ),
		 */
	);
	...
	var $class = array(
		...
		'form'		  => 'Sampleshop_ActionForm',
		'i18n'		  => 'Ethna_I18N',
		'logger'		=> 'Ethna_Logger',
		'plugin'		=> 'Ethna_Plugin',
		'session'	   => 'Ethna_Session',
		'sql'		   => 'Ethna_AppSQL',
		'view'		  => 'Sampleshop_ViewClass',
		'renderer'	  => 'Ethna_Renderer_Smarty',
		'url_handler'   => 'Sampleshop_UrlHandler',
	);
	...
	var $plugin_search_appids = array(
		 ...
		 *  2. Sampleshop_Plugin_Foo_Bar
		 *  3. Ethna_Plugin_Foo_Bar
		 *
		 *  'Common', 'Sampleshop', 'Ethna',
		 */
		'Sampleshop', 'Ethna',
	);
